...
import { Project, Task } from '@/app/types/projects';
...
export default function ProjectDetailsPage() {
  ...
  if (error && !project) {
    return (
      <PageTransition>
        <div className="min-h-screen bg-gradient-to-b from-white to-amber-50 flex items-center justify-center p-6">
  ...
  return (
    <PageTransition>
      <div className="min-h-screen bg-gradient-to-b from-white to-amber-50 p-6">
        <div className="max-w-4xl mx-auto">
          ...
          <motion.section
            ...
            className="rounded-2xl bg-gradient-to-br from-emerald-50/80 to-emerald-100/70 p-6 shadow-lg border border-white/30 mb-6"
          >
              ...
              <div className="flex items-center gap-4 mb-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600 mt-1">
                    This action cannot be undone. All project data and tasks will be permanently deleted.
                  </p>
                </div>
              </div>
